<?php
	class ProjectViewPanel extends QPanel {
		...
		public function __construct($objParentObject, $objProject, $strPanelRightControlId, $strControlId = null) {
			...
			$this->dtgMembers->AddColumn(new QDataGridColumn('ID', '<?= $_ITEM->Id ?>', 'Width=30', array('OrderByClause' => QQ::OrderBy(QQN::Role()->Id), 'ReverseOrderByClause' => QQ::OrderBy(QQN::Person()->Id, false))));
