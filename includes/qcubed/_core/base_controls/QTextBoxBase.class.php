				...
				case QTextMode::Password:
					...
					break;
                                case QTextMode::Number:
                                        $strToReturn = sprintf('<input type="number" min="%s" name="%s" id="%s" value="' . $this->strFormat . '" %s%s />',
                                                $this->intMinLength,    
                                                $this->strControlId,
						$this->strControlId,
						QApplication::HtmlEntities($this->strText),
						...
						$strStyle);
                                        break;
                                case QTextMode::Mobile:
                                        $strToReturn = sprintf('<input type="text" name="%s"  onkeypress="validate(event)" ondrop="return false;" onpaste="return false;" id="%s" value="'. $this->strFormat . '" %s%s  />',
                                                $this->strControlId,
						$this->strControlId,
						QApplication::HtmlEntities($this->strText),
						$this->GetAttributes(),
						$strStyle);
                                    break;    
                                case QTextMode::StringText:
					$strToReturn = sprintf('<input type="text" name="%s" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;" onpaste="return false;" id="%s" value="' . $this->strFormat . '" %s%s />',
						$this->strControlId,
						$this->strControlId,
						QApplication::HtmlEntities($this->strText),
						$this->GetAttributes(),
