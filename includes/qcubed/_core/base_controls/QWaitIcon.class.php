	...
	class QWaitIcon extends QControl {
		...
		public function __construct($objParentObject, $strControlId = null) {
			parent::__construct($objParentObject, $strControlId);
                        //<img class="pageload" src="'.__VIRTUAL_DIRECTORY__ . __IMAGE_ASSETS__.'/spinner_14.gif" style="width: 30px; z-index: 999999999;" alt="Please Wait..."/>
			$this->strText = '<div class="showload"><div class="pageload"><div class="loadhead">Please wait</div><div class="loader"></div><div style="float:left;margin-top: 13px;font-weight: bold;"> Loading...</div><div class="clearfix"></div></div><div class="clearfix"></div></div>';
		}
