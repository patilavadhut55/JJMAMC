<?php
	require(__MODEL_GEN__ . '/LogGen.class.php');
	...
	class Log extends LogGen {
		...
		public function __toString() {
			return sprintf('Log Object %s',  $this->intIdlog);
		}
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of Log objects
			return Log::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Log()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Log()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Log object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Log objects
			return Log::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Log()->Param1, $strParam1),
					QQ::Equal(QQN::Log()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
