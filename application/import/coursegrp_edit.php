<?php
        ...
        require('courseGrpEditPanel.class.php');
        require('courseGrpViewPanel.class.php');
        
    	class CourseGrpEditForm extends QForm{
        ...
        // Initialize our Controls during the Form Creation process
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new CourseGrpViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
            ...
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlCourseView = new CourseGrpViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
           ...
           public function btnNew_Click(){
                    ...
                    $pnlCourseGrpleft = new CourseGrpEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
    }

    
	CourseGrpEditForm::Run('CourseGrpEditForm');
?>