            ...
            protected function Form_Create() {
                ...
                $teachers = LoginHasRole::QueryArray(
                    ...
                    foreach($teachers as $staff){
                        $this->btnprofile[$staff->LoginIdlogin.$staff->RoleIdrole] = new QButton($this);
                        $this->btnprofile[$staff->LoginIdlogin.$staff->RoleIdrole]->HtmlEntities = FALSE ;
                        $this->btnprofile[$staff->LoginIdlogin.$staff->RoleIdrole]->Text = "View";
                        $this->btnprofile[$staff->LoginIdlogin.$staff->RoleIdrole]->ButtonMode = QButtonMode::Success;
                        $this->btnprofile[$staff->LoginIdlogin.$staff->RoleIdrole]->AddAction(new QClickEvent(), new QServerAction('lblview_Click'));
                        $this->btnprofile[$staff->LoginIdlogin.$staff->RoleIdrole]->ActionParameter = $staff->RoleIdrole;
                    }
            }

        protected function lblview_Click($strFormId, $strControlId, $strParameter){
            QApplication::Redirect(__VIRTUAL_DIRECTORY__.__FORM_APPLICATION__."/employee/Nonteaching_staff_report.php?id=".$strParameter);
        }
