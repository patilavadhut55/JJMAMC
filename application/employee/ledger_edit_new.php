  ...
  //require(__FORMBASE_CLASSES__ . '/LedgerEditFormBase.class.php');
    ...
    class LedgerEditForm extends QForm {
        ...
        protected function Form_Create() {
            ...
            $this->btnDocupload = new QButton($this);
            $this->btnDocupload->Text = "Upload";
            $this->btnDocupload->ButtonMode = QButtonMode::Success;
            $this->btnDocupload->CausesValidation = TRUE;
            $this->btnDocupload->AddAction(new QClickEvent(), new QServerAction("btnDocupload_Click"));

            $this->btnScan = new QButton($this);
            $this->btnScan->Text = "Scan";
            $this->btnScan->ButtonMode = QButtonMode::Success;
            $this->btnScan->CausesValidation = TRUE;
            $this->btnScan->AddAction(new QClickEvent(), new QServerAction("btnScan_Click"));
            ...
            // Display list of Cast Category
             if($this->txtCasteCat->SelectedValue!= NULL){
                ...
                protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
                    ...
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/employee/ledger_edit_new.php?emp='.$led->Idledger.'&tab=1'.$param);
                }
                ...
                protected function btnNew_Click() {
                    ...
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/employee/ledger_edit_new.php?new=1'.$param);
		}
...
//                    QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/employee/ledger_edit.php'.$param);
        ...
        protected function lbldelete_click($strFormId, $strControlId, $strParameter){
            ...
            protected function btnDocupload_Click(){
                   
           $led = Ledger::LoadByIdledger($_GET['emp']);
                       
                           $custdocs = AppDocs::QueryArray(
                                  QQ::AndCondition(
                                          QQ::Equal(QQN::AppDocs()->Member, $_GET['emp']),
                                          QQ::Equal(QQN::AppDocs()->Document, $_GET['doc'])
                                         ));
                           if($custdocs){
                       foreach ($custdocs as $custdoc){}
                             $target_file = "../upload/documents/".$custdoc->MemberObject->IdloginObject->Code.".png";
