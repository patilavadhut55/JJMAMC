...
<h1>
    <?php _p('Work Order for ' . $vov->RefNoObject->RefNoObject->Narration); ?>
</h1>
                                ...
                                <table width="649" border="1" >
                                    ...
                                    <tr>
                                        <td colspan="6" style="margin-left:10px;"> 
                                            <div style="font-size:15px;"><strong> Terms    &amp; Conditions:-</strong></div>
                                            <div> 1. Terms of Payment &nbps;&nbps;&nbps;&nbps;:- As mutually agreed after receipt of material.</div>
                                            <div> 2. Taxes :- Inclusive of above price.</div>
                                            <div> 3. Delivery schedule :- Within 10Days from the receipt of W.O. at your end. Otherwise, the said WO will stand cancelled & any liability arising will solely be of 
                                                <?php _p($vov->CrObject); ?>
                                                <?php
                                                if ($adds) {
                                                    foreach ($adds as $add) {
                                                ...
                                                <?php }?>
                                            <div> 4. Destination:- Dr. J.J.Madum Ayurved Medical College,Gat No295, Shirol-Wadi Road,Agarbhag,Jaysingpur.</div>
                                            <div> 5. Mode of Dispatch :- Transportation at your end .</div>
                                            <div> The said work order is issued exclusively subject to Jaysingpur Jurisdiction only.</div>
                                        </td>
                                    </tr>
                                     <tr>
                                         <td colspan="6">
