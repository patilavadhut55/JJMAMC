            ...
            <table class="datagrid" border="1" class="draggable sortable">
                ...
                ?>
                 ...
                 <?php 
                    ...
                    if($reqs){ 
                        foreach ($reqs as $req) {
                            $itemindept[$req->Item] = $req->ItemObject->DisplayName;
                        }
                    }
                    
                    $issuedreqs = IssuedItems::QueryArray(
                                        QQ::AndCondition(
                                            QQ::GreaterOrEqual(QQN::IssuedItems()->Date, date('Ymd000000', strtotime($i))), 
                                            QQ::LessOrEqual(QQN::IssuedItems()->Date, date('Ymd235959', strtotime($i))),
                                            QQ::Equal(QQN::IssuedItems()->FromDept, $_GET['dept'])
                                        ),QQ::GroupBy(QQN::IssuedItems()->Item));    
                ...
                <?php 
                    ...
                    //issued items
                    $issued = IssuedItems::QueryArray(
                                        QQ::AndCondition(
                                            QQ::LessThan(QQN::IssuedItems()->Date, date('Ymd000000', strtotime($i))),
                                            QQ::Equal(QQN::IssuedItems()->FromDept, $_GET['dept']),
                                            QQ::Equal(QQN::IssuedItems()->Item, $key)    
                                        ));    
                    ...
                    //opening qty
                    $openings = DeptTransfer::QueryArray(
                                        QQ::AndCondition(
                    ...
                    //inward qty
                    $inwardreqs = DeptTransfer::QueryArray(
                                        QQ::AndCondition(
                                            QQ::GreaterOrEqual(QQN::DeptTransfer()->Date, date('Ymd000000', strtotime($i))), 
                                            QQ::LessOrEqual(QQN::DeptTransfer()->Date, date('Ymd235959', strtotime($i))),
                                            QQ::Equal(QQN::DeptTransfer()->ToDept, $_GET['dept']),
                    ...
                    //outward qty
                     $outwardreqs = IssuedItems::QueryArray(
                                        QQ::AndCondition(
                                            QQ::GreaterOrEqual(QQN::IssuedItems()->Date, date('Ymd000000', strtotime($i))), 
                                            QQ::LessOrEqual(QQN::IssuedItems()->Date, date('Ymd235959', strtotime($i))),
                                            QQ::Equal(QQN::IssuedItems()->FromDept, $_GET['dept']),
