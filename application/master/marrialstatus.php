<?php
	...
	require('../../qcubed.inc.php');
        require('marrialstatusEditPanel.class.php');
        require('marrialstatusViewPanel.class.php');
	
	class MarrialstatusEditForm extends QForm {
		// Local declarations of our Qcontrols
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new MarrialstatusViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlReligionView = new MarrialstatusViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlReligionleft = new MarrialstatusEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }


    MarrialStatusEditForm::Run('MarrialstatusEditForm');
?>