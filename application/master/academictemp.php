<?php
    ...
    require('academictempEditPanel.class.php');
    require('academictempviewPanel.class.php');
    // Define the Qform with all our Qcontrols
    class AcademictempForm extends QForm {
        ...
        protected function Form_Create() {
            ...
            $this->lstRoles->AddItem('Please Select Department to proceed', null, true);
        ...
        protected function lstRoles_Change($strFormId, $strControlId, $strParameter) {
            ...
            if ($intRoleId = $this->lstRoles->SelectedValue)
                $pnlRoleView = new AcademictempViewPanel($this->pnlLeft, Role::LoadByIdrole($intRoleId), $this->pnlRight->ControlId);
        }
    ...
    AcademictempForm::Run('AcademictempForm');
?>
