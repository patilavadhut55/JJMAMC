<?php
	...
	require('../../qcubed.inc.php');
        require('nationalityEditPanel.class.php');
        require('nationalityViewPanel.class.php');
	
	class NationalityEditForm extends QForm {
		// Local declarations of our Qcontrols
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new NationalityViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlReligionView = new NationalityViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlReligionleft = new NationalityEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }


	NationalityEditForm::Run('NationalityEditForm');
?>