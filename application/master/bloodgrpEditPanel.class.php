<?php
	class BloodgrpEditPanel extends QPanel {
		...
		protected $strMethodCallBack;
                ...
                protected $strTemplate = 'bloodgrpEditPanel.tpl.php';
		public function __construct($objParentObject, $objBlood, $strMethodCallBack, $strControlId = null) {
			// Call the Parent
			try {
	            ...
	            $this->btnDelete->Visible = FALSE; 
                    ...
                    if($this->objBlood == 'new'){
                        $this->objBlood = new BloodGroup();
                        $this->strTitleVerb = "Add New Blood Group";
                    }else{
                        $this->btnDelete->Visible = TRUE;
                        $this->strTitleVerb = $this->objBlood->Name;
                        $this->txtName->Text = $this->objBlood->Name;
                        $this->txtDescription->Text = $this->objBlood->Description;
                    }
		}

		public function btnSave_Click($strFormId, $strControlId, $strParameter) {
                    $this->objBlood->Name = $this->txtName->Text;
                    $this->objBlood->Description = $this->txtDescription->Text;
                    $this->objBlood->Save();
