<?php
	class ReligionEditPanel extends QPanel {
		// General Form Variables
            ...
            protected $strTemplate = 'religionEditPanel.tpl.php';
            public function __construct($objParentObject, $objReligion, $strMethodCallBack, $strControlId = null) {
                    // Call the Parent
                    try {
                ...
                if($this->objReligion== 'new'){
                    $this->objReligion = new Religion();
                    $this->strTitleVerb = "Add New Religion";
                }else{
                    $this->btnDelete->Visible =  True;
                    $this->strTitleVerb = $this->objReligion->Name;
                    $this->txtName->Text = $this->objReligion->Name;
                }
            }

            public function btnSave_Click($strFormId, $strControlId, $strParameter) {
                $this->objReligion->Name = $this->txtName->Text;
                $this->objReligion->Save();
