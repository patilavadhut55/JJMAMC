<?php
	...
	class CourseGrpEditPanel extends QPanel {
		...
		protected $strMethodCallBack;
                ...
                protected $strTemplate = 'CourseGrpEditPanel.tpl.php';
		public function __construct($objParentObject, $objCourse, $strMethodCallBack, $strControlId = null) {
			// Call the Parent
			try {
				...
				throw $objExc;
                    ...
                    // See note in ProjectViewPanel for more on this.
                     ...
                     if($this->objCourse == 'new'){
                         $this->objCourse= new CourseGrp();
                         $this->strTitleVerb = "Add New Course Group";
                         
                     }else{
                        $this->strTitleVerb = $this->objCourse->Name;
                        $this->txtName->Text = $this->objCourse->Name;
                        $this->txtDescription->Text = $this->objCourse->Description;
                     }
		...
		public function btnSave_Click($strFormId, $strControlId, $strParameter) {
                    ...
                    $this->objCourse->Name = $this->txtName->Text;
                    $this->objCourse->Description = $this->txtDescription->Text;
                    $this->objCourse->Save();
