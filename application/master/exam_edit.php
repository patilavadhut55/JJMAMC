<?php
	...
	require('../../qcubed.inc.php');
        ...
        require('ExamListPanel.class.php');
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $this->pnlLeft->CssClass = 'col-md-12 border1';
                    ...
                    $pnlProjectright = new ExamListPanel($this->pnlRight, $this->pnlLeft, 'Test', $this->pnlLeft->ControlId);
                ...
                public function btnnew_Click(){
                    $this->pnlLeft->CssClass = 'col-md-6 border1';
                    $pnlProjectleft = new ExamEditPanel($this->pnlLeft, 'New', "CloseRightPanel");
                }
	}
