<?php
	...
	require('../../qcubed.inc.php');
        require('salaryEditPanel.class.php');
        require('salaryViewPanel.class.php');
	
	class SalaryEditForm extends QForm {
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new SalaryViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                }
               // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        //if ($intRoleId = $this->lstRoles->SelectedValue)
                            $pnlExamView = new SalaryViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlExamleft = new SalaryEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}

	
	salaryEditForm::Run('salaryEditForm');
?>