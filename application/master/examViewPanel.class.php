<?php
	class ExamViewPanel extends QPanel {
            ...
            protected $strTemplate = 'examViewPanel.tpl.php';
			...
			try {
				...
				throw $objExc;
                    ...
                    $this->dtgExam->AddColumn(new QDataGridColumn('Exam Code','<?= $_ITEM->Code ?>'));
                    
                    
                    $Name = new QDataGridColumn('Name', '<?= $_ITEM->Name ?>', 
                                        array(
                                                'OrderByClause' => QQ::OrderBy(QQN::Exam()->Name),
                                                'ReverseOrderByClause' => QQ::OrderBy(QQN::Exam()->Name, false)));

                    $Name->Filter = QQ::Like(QQN::Exam()->Name, null);
                    $Name->FilterPostfix  = '%';
                ...
                public function dtgExam_Bind() {
                    ...
                    $Count = Exam::QueryCount(
                        QQ::AndCondition(
                               $this->dtgExam->Conditions
                                ), QQ::OrderBy(QQN::Exam()->Name)
                        );
                    $this->dtgExam->TotalItemCount = $Count;
                }

                // DataGrid Render Handlers Below
                public function EditColumn_Render(Exam $objExam) {
                    ...
                    $btnEdit->ActionParameter = $objExam->Idexam;
                ...
                public function btnEditExam_Click($strFormId, $strControlId, $strParameter) {
                    ...
                    $objExamToEdit = Exam::LoadByIdexam($strParameter);
                    new ExamEditPanel($pnlRight, $objExamToEdit, 'CloseRightPanel');
                }
	}
?>