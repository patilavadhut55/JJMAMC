<?php
        ...
        require('feeconcessionEditPanel.class.php');
        require('feeconcessionViewPanel.class.php');
        
    	class FeeConcessionEditForm extends QForm{
        ...
        // Initialize our Controls during the Form Creation process
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new FeeConcessionViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
            ...
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlFeeView = new FeeConcessionViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
           ...
           public function btnNew_Click(){
                    ...
                    $pnlFeeleft = new FeeConcessionEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
    }

    
	FeeConcessionEditForm::Run('FeeConcessionEditForm');
?>