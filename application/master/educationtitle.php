<?php
	...
	require('../../qcubed.inc.php');
        require('educationtitleEditPanel.class.php');
        require('educationtitleViewPanel.class.php');
	
	class EducationtitleEditForm extends QForm {
		// Local declarations of our Qcontrols
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new EducationTitleViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlExamView = new EducationtitleViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlExamleft = new EducationtitleEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }

 EducationtitleEditForm::Run('EducationtitleEditForm');
?>