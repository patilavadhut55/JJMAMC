<?php
	...
	require('../../qcubed.inc.php');
        require('./academicyearEditPanel.class.php');
        require('./academicyeaViewPanel.class.php');
    
	class AcademicYearEditForm extends QForm {
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new AcademicYearViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                }
               // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        //if ($intRoleId = $this->lstRoles->SelectedValue)
                            $pnlacademicView = new AcademicYearViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlAcademicyearleft = new AcademicYearEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}

	
	AcademicYearEditForm::Run('AcademicYearEditForm');
?>