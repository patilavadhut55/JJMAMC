<?php
	class MarrialStatusEditPanel extends QPanel {
		// General Form Variables
            ...
            protected $strTemplate = 'marrialstatusEditPanel.tpl.php';
            public function __construct($objParentObject, $objMarrialStatus, $strMethodCallBack, $strControlId = null) {
                    // Call the Parent
                    try {
                ...
                if($this->objMarrialStatus == 'new'){
                    $this->objMarrialStatus = new MarrialStatus();
                    $this->strTitleVerb = "Add New MarrialStatus ";
                }else{
                    $this->btnDelete->Visible = TRUE;
                    $this->strTitleVerb = $this->objMarrialStatus->Name;
                    $this->txtName->Text = $this->objMarrialStatus->Name;
                }
            }

            public function btnSave_Click($strFormId, $strControlId, $strParameter) {
                $this->objMarrialStatus->Name = $this->txtName->Text;
                $this->objMarrialStatus->Save();
