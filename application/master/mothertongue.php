<?php
	...
	require('../../qcubed.inc.php');
        require('mothertongueEditPanel.class.php');
        require('mothertongueViewPanel.class.php');
	
	class MothertongueEditForm extends QForm {
		// Local declarations of our Qcontrols
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new MothertongueViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlReligionView = new MothertongueViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlReligionleft = new MothertongueEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }


    MothertongueEditForm::Run('MothertongueEditForm');
?>