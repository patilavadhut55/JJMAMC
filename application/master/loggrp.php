<?php
        ...
        require('loggrpEditPanel.class.php');
        require('loggrpViewPanel.class.php');
        
    	class LoggrpEditForm extends QForm{
        ...
        // Initialize our Controls during the Form Creation process
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new LoggrpViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
            ...
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlLogView = new LoggrpViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
           ...
           public function btnNew_Click(){
                    ...
                    $pnlLoggrpleft = new LoggrpEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
    }

    
	LoggrpEditForm::Run('LoggrpEditForm');
?>