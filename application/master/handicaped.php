<?php
	...
	require('../../qcubed.inc.php');
        require('handicapedEditPanel.class.php');
        require('handicapedViewPanel.class.php');
	
	class HandicapedEditForm extends QForm {
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new HandicapedViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                }
               // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        //if ($intRoleId = $this->lstRoles->SelectedValue)
                            $pnlExamView = new HandicapedViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlExamleft = new HandicapedEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}

	
	HandicapedEditForm::Run('HandicapedEditForm');
?>