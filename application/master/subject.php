<?php
        ...
        require('./SubjectViewPanel.class.php');
    	class SubjectEditForm extends QForm{
        ...
        protected function Form_Create() {
            ...
            $pnlProjectright = new SubjectViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
        }
        ...
        public function CloseRightPanel($blnUpdatesMade) {
            ...
            if ($blnUpdatesMade) {
               ...
               $pnlSubjectView = new SubjectViewPanel($this->pnlLeft,  'test', $this->pnlRight->ControlId);
          ...
          public function btnNew_Click(){
            ...
            $pnlSubjectleft = new SubjectEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }
	SubjectEditForm::Run('SubjectEditForm');
?>