<?php
        ...
        require('menugrpEditPanel.class.php');
        require('menugrpViewPanel.class.php');
        
    	class MenugrpEditForm extends QForm{
        ...
        // Initialize our Controls during the Form Creation process
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new MenugrpViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
            ...
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlLogView = new MenugrpViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
           ...
           public function btnNew_Click(){
                    ...
                    $pnlLoggrpleft = new MenugrpEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
    }

    
	MenugrpEditForm::Run('MenugrpEditForm');
?>