<?php
	class MenugrpViewPanel extends QPanel {
            ...
            protected $strTemplate = 'MenugrpViewPanel.tpl.php';
			...
			try {
				...
				throw $objExc;
                    ...
                    $this->dtgMenu->AddColumn(new QDataGridColumn('Short Name','<?= $_ITEM->ShortName ?>'));
                ...
                public function dtgMenu_Bind() {
                    ...
                    $this->dtgMenu->DataSource = $Menus;

                    $Count = MenuPosition::QueryCount(
                        QQ::AndCondition(
                               $this->dtgMenu->Conditions
                                ), QQ::OrderBy(QQN::MenuPosition()->Name)
                        );
                    $this->dtgMenu->TotalItemCount = $Count;
                }

                // DataGrid Render Handlers Below
                public function EditColumn_Render(MenuPosition $objMenu) {
                    // Let's specify a specific Control ID for our button, using the datagrid's CurrentRowIndex
                    $strControlId = 'btnEditLog' . $this->dtgMenu->CurrentRowIndex;
                    ...
                    $btnEdit->ActionParameter = $objMenu->IdmenuPosition;
                ...
                public function btnEditMenu_Click($strFormId, $strControlId, $strParameter) {
                    ...
                    $objLogToEdit = MenuPosition::LoadByIdmenuPosition($strParameter);
                    new MenugrpEditPanel($pnlRight, $objLogToEdit, 'CloseRightPanel');
                }
	}
?>