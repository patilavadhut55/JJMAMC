<?php
	...
	require('../../qcubed.inc.php');
        require('roleGrpEditPanel.class.php');
        require('roleGrpViewPanel.class.php');
	
	class RoleGrpForm extends QForm {
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new RoleGrpViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                }
               // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        $pnlGroupView = new RoleGrpViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlGroupleft = new RoleGrpEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}

	RoleGrpForm::Run('RoleGrpForm');
?>