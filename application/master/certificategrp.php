<?php
	...
	require('../../qcubed.inc.php');
        require('certificategrpEditPanel.class.php');
        require('certificategrpViewPanel.class.php');
	class CertificategrpEditForm extends QForm {
            protected $btnNew;
            protected $pnlLeft;
            protected $pnlRight;
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new CertificategrpViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlReligionView = new CertificategrpViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlReligionleft = new CertificategrpEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }

	CertificategrpEditForm::Run('CertificategrpEditForm');
?>