<?php
	...
	require('../../qcubed.inc.php');
        require('gradeEditPanel.class.php');
        require('gradeViewPanel.class.php');
	
	class GradeEditForm extends QForm {
		// Local declarations of our Qcontrols
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new GradeViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlGradeView = new GradeViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlExamleft = new GradeEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }
