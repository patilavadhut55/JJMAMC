<?php
	...
	require('../../qcubed.inc.php');
        require('appointmentcatEditPanel.class.php');
        require('appointmentcatViewPanel.class.php');
	
	class AppointmentcatEditForm extends QForm {
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new AppointmentcatViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                }
               // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        //if ($intRoleId = $this->lstRoles->SelectedValue)
                            $pnlExamView = new AppointmentcatViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlExamleft = new AppointmentcatEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}

	
	AppointmentcatEditForm::Run('AppointmentcatEditForm');
?>