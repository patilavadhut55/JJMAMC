<?php
	class PreQualificationEditPanel extends QPanel {
		...
		protected $strMethodCallBack;
                ...
                protected $strTemplate = 'preQualificationEditPanel.tpl.php';
		public function __construct($objParentObject, $objPreQua, $strMethodCallBack, $strControlId = null) {
			// Call the Parent
			try {
			...
			// Let's record the reference to the form's MethodCallBack
                    // See note in ProjectViewPanel for more on this.
                     ...
                     $this->txtDesc->Name = QApplication::Translate('Description');
                     $this->txtDesc->Required = true;
                     
                     if($this->objPreQua == 'new'){
                         $this->objPreQua = new PreQualification();
                         $this->strTitleVerb = "Add New Qualification";
                         
                     }else{
                        $this->strTitleVerb = $this->objPreQua->Name;
                        $this->txtName->Text = $this->objPreQua->Name;
                        $this->txtDesc->Text = $this->objPreQua->Description;
                     }
		...
		public function btnSave_Click($strFormId, $strControlId, $strParameter) {
                    ...
                    $this->objPreQua->Name = $this->txtName->Text;
                    $this->objPreQua->Description = $this->txtDesc->Text;
                    $this->objPreQua->Save();
