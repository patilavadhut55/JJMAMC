<?php
	...
	require('../../qcubed.inc.php');
        require('examEditPanel.class.php');
        require('examViewPanel.class.php');
	
	class ExamEditForm extends QForm {
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new ExamViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                }
               // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        //if ($intRoleId = $this->lstRoles->SelectedValue)
                            $pnlExamView = new ExamViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlExamleft = new ExamEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}

	
	ExamEditForm::Run('ExamEditForm');
?>