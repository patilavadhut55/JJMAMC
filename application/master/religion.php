<?php
	...
	require('../../qcubed.inc.php');
        require('religionEditPanel.class.php');
        require('religionViewPanel.class.php');
	
	class ReligionEditForm extends QForm {
		// Local declarations of our Qcontrols
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new ReligionViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlReligionView = new ReligionViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlReligionleft = new ReligionEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }

	ReligionEditForm::Run('ReligionEditForm');
?>