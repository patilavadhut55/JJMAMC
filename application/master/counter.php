<?php
	...
	require('../../qcubed.inc.php');
        ...
        require('CounterEditPanel.class.php');
        require('CounterViewPanel.class.php');
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new CounterViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                ...
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        //if ($intRoleId = $this->lstRoles->SelectedValue)
                            $pnlView = new CounterViewPanel($this->pnlLeft,'test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlProjectleft = new CounterEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}
