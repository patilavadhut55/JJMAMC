<?php
	class ExamgrpEditPanel extends QPanel {
		...
		protected $strMethodCallBack;
                ...
                protected $strTemplate = 'ExamgrpEditPanel.tpl.php';
		public function __construct($objParentObject, $objExam, $strMethodCallBack, $strControlId = null) {
			...
			try {
	            ...
	            $this->btnDelete->Visible = FALSE;	
                    ...
                    if($this->objExam == 'new'){
                        $this->objExam = new ExamGroup();
                        $this->strTitleVerb = "Add New Exam Group";
                    }else{
                        $this->btnDelete->Visible= TRUE;
                        $this->strTitleVerb = $this->objExam->Name;
                        $this->txtName->Text = $this->objExam->Name;
                        $this->txtDescription->Text = $this->objExam->Description;
                    }
		...
		public function btnSave_Click($strFormId, $strControlId, $strParameter) {
                    ...
                    $this->objExam->Description = $this->txtDescription->Text;
                    $this->objExam->Save();
