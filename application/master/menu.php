<?php
	...
	require('../../qcubed.inc.php');
        ...
        require('MenuEditPanel.class.php');
        require('MenuViewPanel.class.php');
        
	class MenuForm extends QForm{
		protected $btnNew;
                protected $pnlLeft;
                protected $pnlRight;
		...
		protected function Form_Run() {
			...
			QApplication::CheckRemoteAdmin();
                ...
                protected function Form_Create() {
                    ...
                    $pnlProjectright = new MenuViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
                }
               // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
                public function CloseRightPanel($blnUpdatesMade) {
                    ...
                    if ($blnUpdatesMade) {
                        ...
                        //if ($intRoleId = $this->lstRoles->SelectedValue)
                            $pnlReligionView = new MenuViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                    }
                }
                ...
                public function btnNew_Click(){
                    ...
                    $pnlReligionleft = new MenuEditPanel($this->pnlRight, 'new', "CloseRightPanel");
                }
	}
