<?php
	...
	require('../../qcubed.inc.php');
        require('gardiancatEditPanel.class.php');
        require('gardiancatViewPanel.class.php');
	
	class GardiancatEditForm extends QForm {
		// Local declarations of our Qcontrols
            ...
            protected function Form_Create() {
                ...
                $pnlProjectright = new GardiancatViewPanel($this->pnlLeft, 'Test', $this->pnlRight->ControlId);
            }
           // Method Call back for any of the RightPanel panels (see note in ProjectViewPanel for more information)
            public function CloseRightPanel($blnUpdatesMade) {
                ...
                if ($blnUpdatesMade) {
                    ...
                    //if ($intRoleId = $this->lstRoles->SelectedValue)
                        $pnlExamView = new GardiancatViewPanel($this->pnlLeft,  'Test', $this->pnlRight->ControlId);
                }
            }
            ...
            public function btnNew_Click(){
                ...
                $pnlExamleft = new GardiancatEditPanel($this->pnlRight, 'new', "CloseRightPanel");
            }
    }


	GardiancatEditForm::Run('GardiancatEditForm');
?>