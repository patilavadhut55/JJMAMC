...
if (isset($GLOBALS["HTTP_RAW_POST_DATA"])) {
  ...
  $fp = fopen('D:/xampp/htdocs/yoosme.com/application/upload/documents/A'.$app->Code.'/'.$_GET['doc'].'.png', 'wb' );
...
<button class="btn btn-success" id="snap"  style="width:110px; margin-top: 10px;">Scan</button>
    ...
    <a href="delete.php?id=<?php _p($_GET['id']); ?>&doc=<?php _p($_GET['doc']); ?>"><div class="btn btn-success pull-right" >Delete</div></a>

    <input style="float: right;" class="btn btn-success" type="button" value="Reload" onClick="window.location.reload()">
    
<div style="padding: 5px;  border-radius: 5px; background-color: #FFF; float:right; margin-top: 105px; width: 320px;">
    <input style="color: #000;" class="btn pull-left" type="file" id="imageLoader" name="imageLoader"/>
    <button class="btn btn-success pull-right" id="upload">Upload</button>
</div>
...
<script language="JScript">
    function Delete(){
       ...
       myobject.DeleteFile("D:/xampp/htdocs/esetunashik.com/application/upload/documents/AD320T27820150803065403/97.png");
