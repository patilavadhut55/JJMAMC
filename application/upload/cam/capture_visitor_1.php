...
if (isset($GLOBALS["HTTP_RAW_POST_DATA"])) {
  ...
  if(isset($_GET['id'])) $fp = fopen('../visitorpass/'.$_GET['id'].'.png', 'wb' );
...
<div style="border: 1px #CCC solid; border-radius: 3px; float:left; padding: 5px; margin:2px;">
    <canvas id="canvas" height="86" width="86" style="background-image: url(../visitorpass/<?php echo $_GET['id']; ?>.png)" ></canvas>
</div>
...
<script>
    ...
    window.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("snap").addEventListener("click", function() {
            ...
            ajax.open("POST",'capture_visitor_1.php?id='+code,false);
