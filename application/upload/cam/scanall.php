...
<div style="padding: 5px;  border-radius: 5px; background-color: #FFF; float:right; margin-top: 50px; width: 335px;height: 120px;">
    ...
    <iframe src="../imageupload.php?id=<?php _p($_GET['id']); ?>&doc=<?php _p($_GET['doc']); ?>&flg=1" class="iframe12" style="border: none;width: 330px;height: 110px;" ></iframe>
    <?php }else{?>
    <iframe src="../imageupload.php?id=<?php _p($_GET['id']); ?>&doc=<?php _p($_GET['doc']); ?>" class="iframe12" style="border: none;width: 330px;height: 110px;" ></iframe>
    <?php } ?>
</div>
