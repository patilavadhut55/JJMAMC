...
if (isset($GLOBALS["HTTP_RAW_POST_DATA"])) {
  ...
  $fp = fopen('../documents/A'.$app->Code.'/'.$_GET['doc'].'.png', 'wb' );
...
<?php if(isset($_GET['doc'])){ ?>
    ...
    <a href="sup_delete.php?id=<?php _p($_GET['id']); ?>&doc=<?php _p($_GET['doc']); ?>"><div class="btn btn-success pull-right" >Delete</div></a>
...
<div style="padding: 5px;  border-radius: 5px; background-color: #FFF; float:right; margin-top: 50px; width: 335px;height: 120px;">
    ...
    <iframe src="../supplier_doc_upload.php?id=<?php _p($_GET['id']); ?>&doc=<?php _p($_GET['doc']); ?>&flg=1" class="iframe12" style="border: none;width: 330px;height: 110px;" ></iframe>
    <?php }else{?>
    <iframe src="../supplier_doc_upload.php?id=<?php _p($_GET['id']); ?>&doc=<?php _p($_GET['doc']); ?>" class="iframe12" style="border: none;width: 330px;height: 110px;" ></iframe>
    <?php } ?>
</div>
...
<script>
    ...
    window.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("snap").addEventListener("click", function() {
            ...
            ajax.open("POST",'supplier_doc.php?id='+id,true);
...
<script language="JScript">
    function Delete(){
       ...
       myobject.DeleteFile("../documents/A<?php _p($app->Code."/".$_GET['doc'].".png"); ?>");
