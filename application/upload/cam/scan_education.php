...
if (isset($GLOBALS["HTTP_RAW_POST_DATA"])) {
  ...
  $fp = fopen('D:/xampp/htdocs/yoosme.com/application/upload/education/'.$_GET['id'].'.png', 'wb' );
...
<button class="btn btn-success" id="snap"  style="width:110px; margin-top: 10px;">Scan</button>
    ...
    <a href="delete.php?id=<?php _p($_GET['id']); ?>"><div class="btn btn-success pull-right" >Delete</div></a>
...
<canvas id="canvas" style="-webkit-transform:rotate(-90deg); margin: 80px 0px 0px -75px;
        background-image: url(../education/<?php _p($_GET['id'].'.png'); ?>)" 
...
<script language="JScript">
    function Delete(){
       ...
       myobject.DeleteFile("D:/xampp/htdocs/yoosme.com/application/upload/education/<?php _p($_GET['id'].".png"); ?>");
