    ...
    // Override Form Event Handlers as Needed
          ...
          //       if($this->calFromDate->Text != NULL && $this->calToDate->Text != Null && $this->lstCat->SelectedValue != Null ){
               if(($fdate < $tdate || $fdate == $tdate )&&($this->lstCat->SelectedValue != NULL)){
                    ...
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__.__FORM_APPLICATION__.'/doc_inoutward/report/outward_report.php?fdate='.date('Ymd',  strtotime($this->calFromDate->Text))."&tdate=".date('Ymd',  strtotime ($this->calToDate->Text)));
