    ...
    <div class="form-controls" id="formPrint"> 
        ...
        <table class="datagrid"border="1">
            ...
            $inwards = DocInOut::QueryArray(
                            QQ::AndCondition(
                                    QQ::GreaterOrEqual(QQN::DocInOut()->Date, Date('Ymd', strtotime($_GET['fdate'])) . '000000'), QQ::LessOrEqual(QQN::DocInOut()->Date, Date('Ymd', strtotime($_GET['tdate'])) . '235959'), QQ::Equal(QQN::DocInOut()->DocCateogry, $_GET['cat']), QQ::OrCondition(
                                            QQ::Equal(QQN::DocInOut()->Outward, 0), QQ::Equal(QQN::DocInOut()->Outward, NULL))
            ));
