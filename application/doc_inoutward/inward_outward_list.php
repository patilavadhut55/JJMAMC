    ...
    require('../../qcubed.inc.php');
        ...
        class InwardOutward extends QForm{
            ...
            protected function Form_Create() {
                ...
                $this->dtgOutword->ShowFilter = TRUE;
                ...
                $Name = new QDataGridColumn('Code', '<?= $_ITEM->DocInOutObject->Code ?>', 'Width=10',
                            array(
                                    'OrderByClause' => QQ::OrderBy(QQN::MarkTo()->DocInOutObject->Code),
                                    'ReverseOrderByClause' => QQ::OrderBy(QQN::MarkTo()->DocInOutObject->Code, false)));

                $Name->Filter = QQ::Like(QQN::MarkTo()->DocInOutObject->Code, null);
                ...
                $Name = new QDataGridColumn('Subject', '<?= $_ITEM->DocInOutObject->DocumentGrp ?>', 'Width=250',
                            array(
                ...
                $this->dtgOutword->AddColumn(new QDataGridColumn('Status', '<?= $_ITEM->DocInOutObject->Closed == TRUE? "Closed" : "Forwarded"  ?>','Width=50'));
                $this->dtgOutword->AddColumn(new QDataGridColumn('Sender', '<?= $_ITEM->DocInOutObject->InwordByObject  ?>','Width=50'));


                $this->dtgOutword->SetDataBinder('dtgOutword_Bind');

                $this->dtgOutword->RowActionParameterHtml = '<?= $_ITEM->DocInOut  ?>';
                $this->dtgOutword->AddRowAction(new QClickEvent(), new QServerAction('dtgOutwordRow_Click'));
            ...
            public function dtgOutwordRow_Click($strFormId, $strControlId, $strParameter) {
                QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/doc_inoutward/inward_outward.php?id1='.$strParameter);
            }
