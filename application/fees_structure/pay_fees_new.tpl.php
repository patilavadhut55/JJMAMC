    ...
    <table border="0" style="width:100%; margin-top: 30px;">
        ...
        <tr>
            ...
            <td valign="top" width="30%">
                <?php if(isset($_GET['view']) != 1){?>
                <table style="float:left; width: 290px; margin-left: 20px;" >
                    <tr>
                        <td><div class="pull-left"><b>Year&nbsp;&nbsp;&nbsp;&nbsp;</b></div></td>
                        <td><div class="pull-left"><?php $this->lstYear->Render(); ?></div></td>
                    </tr>
                    
                    <tr>
                        <td><div class="pull-left"><b>Academin Year&nbsp;&nbsp;&nbsp;&nbsp;</b></div></td>
                        <td><div class="pull-left"><?php $this->lstCal->Render(); ?></div></td>
                    </tr>
                </table>
                <?php }?>
            </td>
            ...
            <td colspan="2">
                ...
                <div style="float: left; width: 70%; margin-top: 15px;">
                    <table width="100%" border="1" class="datagrid" >
                        ...
                        <?php
                        $sr = $rpayable = $total1=$total2=$total3=$now=0;     
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <?php 
                                    $rpayable = round($fee->Amount);
                                    _p($rpayable);             
                                    $totalpayable =$rpayable;
                                ?>
                            </td>
                            <td>
                                <div align="right">
                            ...
                            <td><div align="right"><?php  $bal = round($totalpayable - $totalpaid); _p(number_format($bal,2,'.','')); ?></div></td>
                            <td><div align="center"><?php if($bal > 0 || (isset($_GET['id']) && $this->txtnow[$fee->Idvoucher]->Text != "")) $this->txtnow[$fee->Idvoucher]->Render();  ?></div></td>
                            <?php if(isset($_GET['id'])){ ?>
                            <td align="center"><?php $this->lbldelete[$fee->Idvoucher]->Render(); ?></td>
                            <?php } ?>
                        </tr>
                        <?php 
                    ...
                    <table width="290" border="0" class="datagrid">
                        ...
                        <tr>
                            <td colspan="3">
                                <div align="left">
                                    <strong>
                                        <?php _p(trim($status->SemisterObject." - "." (".$status->CalenderYearObject.")"." - ".$status->AdmissionStatusObject)); ?>
                                    </strong>
                                </div>
                            </td>
                        </tr>
                        <?php
                            ...
                            $paids = Voucher::QueryArray(
                                        ...
                                        QQ::Equal(QQN::Voucher()->RefStatus, $status->IdcurrentStatus),
                                        QQ::Equal(QQN::Voucher()->RefStatusObject->CalenderYear,$status->CalenderYear),
                        ...
                        <tr <?php if($paid->CrObject->Grp != 244){ ?>  onclick= " window.open('../report/government_receipt.php?mem=<?php _p($_GET['mem']); ?>&id=<?php _p($paid->Idvoucher); ?>')" <?php }else{ ?>  onclick= " window.open('pay_fees_new.php?mem=<?php _p($_GET['mem']); ?>&id=<?php _p($paid->Idvoucher); ?>&year=<?php _p($paid->AcademicYear); ?>&cal=<?php _p($paid->RefStatusObject->CalenderYear);?>')"<?php } ?>>
                            ...
                            <td>
                                <div align="right">
                                    <?php  _p(number_format($totalamt,2,'.',''));
                                    if(!$amt->Cancel) $totpaid = $totpaid + $totalamt; ?>
                                </div>
                            </td>                        
                        </tr>
                        <?php }}} ?>
                        ...
                        ?>
                        <tr onclick= " window.open('../report/government_receipt.php?mem=<?php _p($_GET['mem']); ?>&id=<?php _p($deppaid->Idvoucher); ?>')">
