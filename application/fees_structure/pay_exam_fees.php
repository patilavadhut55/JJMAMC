    ...
    class PayFees extends QForm {
        ...
        protected function lbldels_Click($strFormId, $strControlId, $strParameter){
            $vov = Voucher::LoadByIdvoucher($strParameter);            
                ...
                if($vov->Parrent == NULL){
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem']);
                }else{
                    $this->Refresh();
                }
            ...
            if($this->txtnow[$strParameter]->Text != ""){
               $currents = CurrentStatus::QueryArray(
                ...
                if(isset($_GET['id'])){
                    ...
                    if(!$vhps){
                        ...
                        if($refvov){
                            ...
                            if($this->txtnow[$strParameter]->Text <= $ref->Amount){
                                ...
                                $vhp->Save();
                                $subvov = $subvov + 1;
                                QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$_GET['id'].'&sub='.$subvov);
                            }else{
                                
                                QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$_GET['id']);
                            }
                    ...
                    if(isset($_GET['year'])){
                        QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$vhp->Idvoucher.'&year='.$_GET['year']);
                    }elseif(isset($_GET['view'])){
                        QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$vhp->Idvoucher.'&view=1');
                    }else{
                        QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$vhp->Idvoucher);
                    }
                }
            }else{
        ...
        protected function Refresh(){
            if(isset($_GET['year'])){
                QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$_GET['id'].'&year='.$_GET['year']);
            }elseif(isset($_GET['sub'])){
                QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$_GET['id'].'&sub='.$_GET['sub']);
            }else{      
                QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$_GET['id']);  
            }
        }
        protected function lstYear_Change(){
            if(isset($_GET['mem']) && !isset($_GET['id'])){
                ...
                if($CurrentStatus){
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&year='.$this->lstYear->SelectedValue); 
                }else{
              ...
              $CurrentStatus = CurrentStatus::QueryArray (
                ...
                if($CurrentStatus){
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$_GET['mem'].'&id='.$_GET['id'].'&year='.$this->lstYear->SelectedValue); 
                }else{
                    QApplication::DisplayAlert("No Status for this student of year ".$this->lstYear->SelectedName.' Add from admission module or contact administrative person');
                }
            }    
        ...
        protected function btnSearch_click($strFormId, $strControlId, $strParameter) {
                ...
                if($currents)
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/fees_structure/pay_exam_fees.php?mem='.$mem->Idledger); 
                else
        ...
        protected function btnSave_click($strFormId, $strControlId, $strParameter) {
            ...
            if(isset($_GET['view'])){
                ...
                QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APPLICATION__ . '/report/exam_fee_receipt.php?id='.$_GET['id']); 
            }
