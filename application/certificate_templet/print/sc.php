                    ...
                    <tr>
                        ...
                        <table width="100%" style=" font-size:12px; font-weight:bold; width: 100%">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 55%;">
                                    <div style="float:left; width: 100%;">Place:<!--?php _p($adddres->TalukaObject.'.  Dist. '.$adddres->DistrictObject); ?--><br />
                                    ...
                                    Date:- <!--?php if($app->CertificateGeneratedDate) _p(date('d/m/Y', strtotime($app->CertificateGeneratedDate)));?--></div>
                                    </td>
                                    <td style="width: 30%;">
                                    <div style="width: 100%;" align="center"><!--?php _t($app->SignPatch); ?--></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
