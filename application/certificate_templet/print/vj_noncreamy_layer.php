                    ...
                    <tr>
                        ...
                        <div style="margin-bottom: -10px;">
                            ...
                            if($M <= 3){
                                $Year = $Y - 1;
                                $Year1 = $Y;      
                                _p('Income '.$Year. " - " .$Year1);
                            }else{
                                $Year = $Y + 1;
                                _p('Income '.$Y. " - " .$Year);
                            }    
                           ?--></div>
                            <div style="float: left; margin-left: 5px;"><!--?php $this->txtData1->Render();?--></div><div style="clear: both;"></div>
                        </div>
                        <div style="">
                           ...
                           ?--></div>
                            <div style="float: left; margin-left: 5px;"><!--?php $this->txtData2->Render();?--></div><div style="clear: both;"></div>
                        </div>    
                        <div style="">
                            <div style="float: left;">
                            <!--?php 
                            if($M <= 3){
                                ...
                                $Year = $Y - 1;
                                $Year1 =$Y - 2; 
                                _p('Income '.$Year1. " - " .$Year);
                            }    
                            ?--></div>
                            <div style="float: left; margin-left: 5px;"><!--?php $this->txtData3->Render();?--></div> <div style="clear: both;"></div>
                        </div>    
                            <div style="clear: both;"></div>
                        </td>
                    </tr>
