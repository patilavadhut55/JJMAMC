        ...
        <tr>
            ...
            <table id="stable" align="center">
                <tbody>
                    <tr>
                        <td align="center">
                        <div id="title1"><strong>Form-8<br />
                        Rule No. 5(6)</strong></div>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        <div id="title2"><strong><br />
                        Form of Certificate For De-Notified Tribe (Vimukta Jati), Nomadic Tribe/Other Backward Class/Special Backward Category person belonging to the State of Maharashtra</strong></div>
                        </td>
                    </tr>
                    <tr>
