...
<p class="western" align="CENTER" style="margin-bottom: 0in; direction: ltr; line-height: 13.3333px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;"><font face="Baskerville Old Face, serif"><font style="font-size: 16pt;"><b>CERTIFICATE</b></font></font></p>
...
<p class="western" align="JUSTIFY" style="margin-bottom: 0in; direction: ltr; line-height: 33.3333px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;"><font size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that&nbsp;</font><font size="4"><b><!--?php $name = GetFullNameNew($app->ApplicantObject->OfObject->Name, $app->ApplicantObject->OfObject->Code);
$name1= explode('.',$name);
if(isset($name1[1]))
_p($gen.$name1[1]);
elseif(!isset($name1[1]))
    _p($gen.$name);
?-->&nbsp;</b></font><font size="4">was a bonafide student of this college during <font size="4"><b>June</b></font>&nbsp;</font><font size="4"><b> <!--?php _p(date('Y',  strtotime($year->CalenderYearObject->From)));?-->&nbsp;to May&nbsp;<!--?php _p(date('Y',  strtotime($year->CalenderYearObject->To))); ?-->.</b></font><font size="4">&nbsp;<!--?php _p($gen1);?--> has passed&nbsp;</font><font size="4"><b><!--?php _p(' '.delete_all_between('[', ']',$year->RoleObject->ParrentObject->ParrentObject->Name).' '.delete_all_between('[',']',$year->RoleObject->ParrentObject->Name)); ?-->&nbsp;</b></font><font size="4">full time regular programme of Shivaji University, Kolhapur, from our college.
Further it is certified that the medium of instruction of the said four year degree programme was in English.
This certificate issued on the request by student.
</font></p>
...
<p class="western" align="RIGHT" style="margin-bottom: 0in; direction: ltr; line-height: 26.6667px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;"><a name="_GoBack"></a><font style="font-size: 16pt;"><b>Director</b></font></p>
