...
<p class="western" align="CENTER" style="margin-bottom: 0in; direction: ltr; line-height: 13.3333px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;"><font face="Baskerville Old Face, serif"><font style="font-size: 16pt;"><u><b>CERTIFICATE</b></u></font></font></p>
...
<p class="western" align="JUSTIFY" style="margin-bottom: 0in; direction: ltr; line-height: 26.6667px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;"><font size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that&nbsp;</font><font size="4"><b><!--?php $name = GetFullNameNew($app->ApplicantObject->OfObject->Name, $app->ApplicantObject->OfObject->Code);
$name1= explode('.',$name);
if(isset($name1[1]))
_p($gen.$name1[1]);
elseif(!isset($name1[1]))
   ...
   ?-->&nbsp;</b></font><font size="4">PRN No</font><font size="4"><b>.<!--?php _p($app->ApplicantObject->OfObject->Code);    ?-->&nbsp;</b></font><font size="4">is currently in the <!--?php _p(' '.delete_all_between('[',']', $year->SemisterObject->ParrentObject->Name).' '.delete_all_between('[', ']',$year->RoleObject->ParrentObject->ParrentObject->Name).' '.delete_all_between('[',']',$year->RoleObject->ParrentObject->Name));    ?--> during the academic year   <!--?php 
    _p($year->CalenderYearObject->Name);
    ?--> in this college and has obtained at least 50% of marks based on latest available grades.<!--?php _p($gen1);    ?--> is likely to appear for<!--?php _p(' '.delete_all_between('[',']', $year->SemisterObject->ParrentObject->Name).' '.delete_all_between('[', ']',$year->RoleObject->ParrentObject->ParrentObject->Name).' '.delete_all_between('[',']',$year->RoleObject->ParrentObject->Name));    ?--> Examination to be held in May&nbsp;<!--?php _p(' '.date('Y',strtotime($year->CalenderYearObject->To)))   ?-->, conducted by Walchand College of Engineering Sangli. The result of the said examination would likely to be declared on May&nbsp;<!--?php _p(date('Y',  strtotime($year->CalenderYearObject->To)))   ?-->.</font></p>
<p class="western" align="JUSTIFY" style="margin-bottom: 0in; direction: ltr; line-height: 26.6667px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;"><font size="4">This certificate has been issued to enable the candidate to apply for CAT &ndash;<!--?php _p(date('Y',  strtotime($year->CalenderYearObject->From)))   ?-->.</font></p>
<p class="western" align="JUSTIFY" style="margin-bottom: 0in; direction: ltr; line-height: 26.6667px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;"><font size="4">This certificate issued on the request by student</font></p>
<p class="western" align="JUSTIFY" style="margin-bottom: 0in; direction: ltr; line-height: 26.6667px; font-family: &quot;Times New Roman&quot;, serif; font-size: 10pt;">&nbsp;</p>
