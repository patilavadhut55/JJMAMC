    ...
    <div class="form-controls" id="formPrint"> 
        ...
        <table class="datagrid"border="1">
            <tr>
                ...
                <th width="4%"><div align="center">Document No.</div></th>
            ...
            $inwards = DocInOut::QueryArray(
                            QQ::AndCondition(
                                    ...
                                    QQ::Equal(QQN::DocInOut()->DocCateogry, $_GET['cat']), QQ::OrCondition(
                ...
                if ($marks) {
                    foreach ($marks as $mark) {
                        ...
                        <tr> 
                            ...
                            <td><div align="center"><?php _p($inward->DocumentCode); ?></div></td>
