...
<div class="form-controls">
    <table width="910" border="0">
        ...
        <tr>            
            ...
            <td><strong>Class (Optional)</strong><?php $this->lstSemister->Render(); ?></td>            
            <td><strong>Payment Mode (Optional)</strong><?php $this->lstPaymentMode->Render(); ?></td>
    ...
    <div id="formPrint">
                    ...
                    if(isset($_GET['paymode'])){
                        $Voucher = Voucher::QueryArray(
                                        QQ::AndCondition(
                                            ...
                                            QQ::Equal(QQN::Voucher()->Grp,7),
                                            QQ::Equal(QQN::Voucher()->Dr,22 ),
                                            QQ::Equal(QQN::Voucher()->PaymentMode,$_GET['paymode']),
                                            QQ::Equal(QQN::Voucher()->Parrent,NULL),
                                        QQ::OrCondition(
        ...
        <table border="1" cellspacing ="0" style="font-size:12px;" class="datagrid">
            <tr>
                ...
                <th width="70" >Name</th>
                <th width="70" >Payment Mode</th>
                <th width="60" >Calender Year</th>
           ...
           <?php 
                    ...
                    foreach ($Voucher as $vouch){
                        ...
                        $tution = $dev = $total1 = $total2 = $total =  0;
            ...
            ?>
                    <tr> 
                        ...
                        <td><?php _p($vouch->RefStatusObject->CalenderYearObject->Name);?></td>
                        <!-- Tution fee -->
                        <?php 
                    ...
                    ?>
                       <tr> 
                        ...
                        <td><?php if($vouch->CrObject->Grp == 244) _p($vouch->CrObject->Name); else _p($vouch->CrObject->GrpObject->Name); ?></td>
                        <td><?php _p($vouch->PaymentModeObject);?></td>                        
                        <td><?php _p($vouch->RefStatusObject->CalenderYearObject);?></td>
                        <!-- Tution fee -->
                        <?php 
                            $tuvov = Voucher::QuerySingle(
                                    QQ::AndCondition(
