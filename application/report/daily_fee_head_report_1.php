		...
		protected function Form_Create() {
                ...
                protected function Report(){
                    if ($this->calfrom->Text != "" && $this->calto->Text != "" && $this->lstYear->SelectedValue == NULL && $this->lstSemister->SelectedValue == NULL && $this->lstadmission->SelectedValue == NULL) {
                        QApplication::Redirect(__VIRTUAL_DIRECTORY__.__FORM_APPLICATION__.'/report/daily_fee_head_report'. '.php?from='.date("Ymd",  strtotime($this->calfrom->Text)).'&to='.date("Ymd",  strtotime($this->calto->Text)));
                    }
                    if ($this->calfrom->Text != "" && $this->calto->Text != "" && $this->lstYear->SelectedValue != NULL && $this->lstSemister->SelectedValue != NULL && $this->lstadmission->SelectedValue != NULL) {
                        QApplication::Redirect(__VIRTUAL_DIRECTORY__.__FORM_APPLICATION__.'/report/daily_fee_head_report'. '.php?from='.date("Ymd",  strtotime($this->calfrom->Text)).'&to='.date("Ymd",  strtotime($this->calto->Text)).'&acdyear='.$this->lstYear->SelectedValue.'&semi='.$this->lstSemister->SelectedValue.'&addyear='.$this->lstadmission->SelectedValue);
                    }
