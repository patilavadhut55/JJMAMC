...
<div style="font-size: 14px; float: left; line-height:20px; width:48%; padding:10px;" >
    ...
    <table style="width:100%"  border="0">
        ...
        <tr>
            ...
            <td width="45%" align="center"><div style="border: 1px solid #999; border-radius: 10px;">Admission RECEIPT</div></td>
            <td valign='center'><div style="border-bottom: 1px solid lightgray;"></div></td>
        </tr>
        <tr>
    ...
    <table width="85%"  border="1" class="datagrid" style="width:">
        <tr>
            <th width="11%">Sr.</th>
    ...
    <div style="margin-left: 10px;"><strong>Rs.(in words) </strong><u><?php _p(convert_number($totalpaid)); ?>  Only.</u></div>
<div style="margin-top: 20px; margin-left: 10px;">
    <div class="col-md-4" style=""></div>
    <div class="col-md-4" style=""></div>
    <div class="col-md-4" style=""><strong>Authority </strong></div>
</div>
