        ...
        $gtutions = Voucher::QueryArray(
                    ...
                    if($gtutions){
                        foreach ($gtutions as $gtution){
                            ...
                            //Payable Amount
                            $totalpayable = round($gtution->Amount);
...
//                                        $totalpaid = $totalpaid + $vhp->Amount;
        ...
        <div style="float: right;"> Dues : <?php _p(number_format($total3,2,'.','')); ?></div>
         ...
         <table style="width: 100%;" border="0"> 
            ...
            <tr>
                <td><strong>Name : </strong><?php _p($vov->CrObject->GrpObject->Profile->FirstName.' '.$vov->CrObject->GrpObject->Profile->MiddleName.' '.$vov->CrObject->GrpObject->Profile->LastName); ?> </td>
            ...
            <tr>
                ...
                <td><strong> Paying Category : </strong><?php _p($vov->CrObject->GrpObject->Profile->FeeConcessionObject);?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><?php if($i != 1){ _t("<strong>Mobile No </strong>".$vov->CrObject->GrpObject->Profile->Contact1); } ?></td>
            </tr>
        </table>
