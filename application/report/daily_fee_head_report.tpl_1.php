            ...
            ?>
                    <tr> 
                        ...
                        <?php 
                            ...
                            ?>
                        <td><a href="repeat_fee_print.php?id=<?php _p($vouch->Idvoucher); ?>&mem=<?php _p($vouch->Cr);?>"><?php _p($vouch->InvNo);?></a></td>
                                ...
                                foreach ($leds as $led) {
                                    ...
                                    <td align = "right">
                                        ...
                                        if ($ledvovs) {
                                            ...
                                            $arrled[$led->Idledger]+= $ledv->Amount;
                                        } else {
                                            _p("0");
                                        }
                                        ?>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        if ($leds) {
                            foreach ($leds as $led) {
                            ?>
                        <td align="right"><strong><?php _p(number_format($arrled[$led->Idledger], 2,'.',''))?></strong></td>
                            <?php 
                            }
                        }
                        ?>
