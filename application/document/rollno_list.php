        ...
        class StudentReport extends QForm {
            ...
            protected function btnReport_Click(){
                if($this->lstCal->SelectedValue != NULL && $this->lstProgram->SelectedValue != NULL && $this->lstTeachDept->SelectedValue != NULL && $this->lstSem->SelectedValue && $this->lstSpecialization->SelectedValue){
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__.__FORM_APPLICATION__."/document/rollno_list.php?cal=".$this->lstCal->SelectedValue."&dept=".$this->lstProgram->SelectedValue."&program=".$this->lstTeachDept->SelectedValue."&special=".$this->lstSpecialization->SelectedValue."&year=".$this->lstSem->SelectedValue);
