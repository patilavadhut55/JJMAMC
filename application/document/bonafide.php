...
<div style="margin-left:8%; font-size:20px; ">Shri / Miss <strong><!--?php  _p(GetFullNameNew($CurrentStatus->StudentObject->IdloginObject->Name,$CurrentStatus->StudentObject->IdloginObject->Code));?>--></strong>         Roll No.<strong><!--?php _p($CurrentStatus->RollNo);  ?--></strong><span style="color: #D6D7D6">    </span>is/was a bonafide Student of this         College and is / was Studying in &nbsp; <strong><!--?php _p($CurrentStatus->SemisterObject->ParrentObject->Name); ?--> <!--?php _p(delete_all_between ("[", "]",$CurrentStatus->RoleObject->ParrentObject->Name)); ?--></strong>         Class During the academic year  &nbsp;<strong> <!--?php _p($CurrentStatus->CalenderYearObject->Name) ?--> </strong></div>
