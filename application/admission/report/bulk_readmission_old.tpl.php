    ...
    <?php if($this->lstCal->SelectedValue && $this->lstSem->SelectedValue && $this->lstProgram->SelectedValue){ ?>
        ...
        <table border="1" class="datagrid col-md-12 draggable sortable">
            <tr>
                ...
                <?php
                    ...
                    $students = CurrentStatus::QueryArray(
                                        QQ::AndCondition(
                                            ...
                                            QQ::Equal(QQN::CurrentStatus()->RoleObject->Parrent, $this->lstProgram->SelectedValue),
                ...
                ?>
                <tr>
                    <td><?php /*  $this->lbldel[$student->Student.$student->Role]->Render();*/ _p('  '.$Sr++); ?></td>
                    ...
                    <td>
                        <div>
                            <div style="float: left; margin-right: 15px;"><?php $this->chkSelect[$student->Student.$student->Role]->Render(); ?></div>
                            <div style="float: left;"><?php $this->lbldel[$student->Student.$student->Role]->Render();?></div>
                        </div>
                    </td>
                </tr>
                        <?php }}}?>
