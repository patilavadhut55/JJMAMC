		...
		protected function Form_Create() {
            ...
            protected function Report(){
                if($this->lstYear->SelectedValue != NULL && $this->lstCourse->SelectedValue != NULL){
                    QApplication::Redirect(__VIRTUAL_DIRECTORY__.__FORM_APPLICATION__.'/admission/report1/feecatwise_report.php?dept='.$this->lstCourse->SelectedValue.'&cal='.$this->lstYear->SelectedValue);
                }else{
