...
<div style="overflow: auto;">
       ...
       <table width="100%" class="datagrid" border="1">
            <tr>
                ...
                <th><strong>Age as on Date</strong></th>
                <th><strong>Father Name</strong></th>
                <th><strong>Relation With Student</strong></th>
            ...
            <tr>
                        ...
                        <td><?php _p($dists->StudentObject->IdloginObject->Profile->Dob);?></td>
                        <td><?php _p($dists->StudentObject->IdloginObject->Profile->Age);?></td>
                        <td><?php _p($dists->StudentObject->IdloginObject->Profile->FatherFirstName) . _p($dists->StudentObject->IdloginObject->Profile->FatherMiddleName) . _p($dists->StudentObject->IdloginObject->Profile->FatherLastName);?></td>
                       <td><?php _p($dists->StudentObject->IdloginObject->Profile->RelationOfApplicantWithGuardian);?></td>
                       <td></td>
