...
<div class="form-controls">
    <table style="width: 100%;" border="0">
       ...
       <tr>
            <td width="421"><?php $this->lstdist->RenderWithName(); ?></td>
            <td width="421"><?php $this->lstTal->RenderWithName(); ?></td>
        </tr>
        <tr>
...
<div style="overflow: auto;">
       ...
       <table width="100%" class="datagrid" border="1">
              ...
              if(isset($_GET['dist'])){
               ...
               $dist =  CurrentStatus::QueryArray(
                   QQ::AndCondition(
                         ...
                         QQ::Equal(QQN::CurrentStatus()->StudentObject->IdloginObject->Profile->Taluka,$_GET['id']), 
                         QQ::Equal(QQN::CurrentStatus()->StudentObject->IdloginObject->Profile->District,$_GET['dist']) 
                    )
                );  
            ...
            <tr>
                        ...
                        <td><?php _p($dists->StudentObject->IdloginObject->Profile->City);?></td>
                        <td><?php _p($dists->StudentObject->IdloginObject->Profile->Taluka1Object);?></td>
