  ...
  <table width="100%" class="datagrid" border="1">
                        ...
                        <tr>
                            ...
                            <th>Batch</th>
                              ...
                              <?php 
                              $qutotas = UniversityReservation::LoadAll();
                              $totalAll = array();
                              $grand = 0;
                                foreach ($qutotas as $qutota){
                                    $totalAll[$qutota->IduniversityReservation] = 0;
                                 ?>    
                               
                                <th> <?php _p($qutota->Name);?>   </th>
            ...
            <tr>
                ...
                $countquo =  CurrentStatus::QueryCount(
                    QQ::AndCondition(
                        ...
                        QQ::Equal(QQN::CurrentStatus()->StudentObject->IdloginObject->Profile->UniversityReservation,$qutota->IduniversityReservation) 
                    )
                );  
           
          
               $total = $total + $countquo;  
               $totalAll[$qutota->IduniversityReservation] =$totalAll[$qutota->IduniversityReservation]+  $countquo;
               
            ?>
                
                   <td> <?php _p($countquo); ?>   </td>
                <?php  }  ?>    
            ...
            <tr>
                ...
                <td></td>
                 <td></td>
              <?php  foreach ($qutotas as $qutota){?>
                
                 <td><strong><?php _p(  $totalAll[$qutota->IduniversityReservation]); ?></strong></td>
